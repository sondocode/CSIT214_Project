<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lecturer_dashboard.aspx.cs" Inherits="CSIT214_project.lecturer_dashboard" %>
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="well">
        <h4>Dashboard</h4>
        <p>Hi, lecturer. Welcome to UOW attendance system.</p>
      </div>
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
            <img src="https://www.trzcacak.rs/myfile/full/34-347409_teachers-tech-teacher-icon.png" width="75" height="75" alt="studentImg" style="float:left;"/>
        ...
        <div class="col-sm-3">
          <div class="well">
            <img src="https://blog.edgenuity.com/wp-content/uploads/2016/09/teacher-icon.png" width="75" height="75" alt="studentImg" style="float:left;"/>
        ...
        <div class="col-sm-3">
          <div class="well">
            <img src="https://png.pngtree.com/svg/20170324/lecture_745517.png" width="75" height="75" alt="studentImg" style="float:left;"/>
        ...
        <div class="col-sm-3">
          <div class="well">
            <img src="https://kkarasavvas.com/img/timeline/lecturer1.png" width="75" height="75" alt="studentImg" style="float:left;"/>
