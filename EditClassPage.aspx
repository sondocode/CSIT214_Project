<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditClassPage.aspx.cs" Inherits="CSIT214_project.EditClassPage" %>
...
<body>
    ...
    <div class="loginContainer">
        <div class="loginHeader">
            <div class="loginHeaderSpan">EDIT CLASS</div>
        </div>
        <form id="form8" runat="server">
        <div class="loginPart"">
            
            <asp:GridView ID="ClassGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" CellSpacing="5" OnRowEditing="ClassGridView_RowEditing" OnRowUpdating="ClassGridView_RowUpdating" OnRowDeleting="ClassGridView_RowDeleting" DataKeyNames="classSubCode" OnRowCancelingEdit="btnCancel">
                <Columns>
                    <asp:BoundField DataField="classSubCode" HeaderText="CLASS SUBJECT CODE" ReadOnly="true" SortExpression="classSubCode" />
                    <asp:BoundField DataField="classSubName" HeaderText="CLASS SUBJECT NAME" SortExpression="classSubName" />
                    <asp:BoundField DataField="classLocation" HeaderText="CLASS LOCATION" SortExpression="classLocation" />
